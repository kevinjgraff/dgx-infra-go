...
import (
	...
	"github.com/kevinjgraff/dgx-infra-go/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "8a4b9397.example.com",
	...
	if err := (&controller.GPUHealthPolicyReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
		Recorder: mgr.GetEventRecorderFor("gpu-ops-operator"),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "GPUHealthPolicy")
		os.Exit(1)
	}
